...
// Template placeholder: map your own school/company names to logo
// images here, e.g. { "Your University": yourLogo }. The generic icon
// fallback below keeps everything rendering fine with zero logos.
 ...
 * Matching is prefix-based so variants of the same name resolve too.
 */
